...
const AddToDoForm = () => {
  ...
  return (
    <div className=" sm:w-[80%]   mt-10 bg-gray-100 flex flex-col items-center h-[550px]  rounded-xl ">
      <div className="bg-amber-200 flex ">
        <div className="mr-[]">
            <p className="flex  ">Add a task</p>
        </div>
        
        <div>
          <button className="flex ">Close</button>
        </div>
      </div>

      <div className="sm:w-[95%]">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className=" mt-10  w-[100%] flex flex-col sm:w-[100%]">
            <p className="">Title</p>
            <input
            ...
            <select className="mb-5 bg-white rounded-sm w-[99%] p-2">
